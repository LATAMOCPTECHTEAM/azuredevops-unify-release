...
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var variableManager, releaseTag, waitForAllTriggeredBuilds, definition1, definition2, definition3, definition4, definition5, releaseOnCancel, releaseOnError, teamfoundationCollectionUri, teamfoundationProject, accessToken, currentBuildId, devOpsClient, buildDetails, relatedBuilds, shouldCreateTag, _a, _b, build, err_1;
        var e_1, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _d.trys.push([0, 5, , 6]);
                    variableManager = tsyringe_1.container.resolve(variableManager_1.default);
                    releaseTag = variableManager.getInput('releaseTag', true);
                    waitForAllTriggeredBuilds = variableManager.getBooleanInput('waitForAllBuilds', false);
                    definition1 = variableManager.getInput('definition1', false);
                    definition2 = variableManager.getInput('definition2', false);
                    definition3 = variableManager.getInput('definition3', false);
                    definition4 = variableManager.getInput('definition4', false);
                    definition5 = variableManager.getInput('definition5', false);
                    releaseOnCancel = variableManager.getBooleanInput('releaseOnCancel', true);
                    releaseOnError = variableManager.getBooleanInput('releaseOnError', true);
                    teamfoundationCollectionUri = variableManager.getVariable("SYSTEM_TEAMFOUNDATIONCOLLECTIONURI");
                    teamfoundationProject = variableManager.getVariable("SYSTEM_TEAMPROJECT");
                    accessToken = variableManager.getVariable("SYSTEM_ACCESSTOKEN");
                    currentBuildId = variableManager.getVariable("BUILD_BUILDID");
